...
/**
 * Delegate to retrieve parameters from request path.
 *
...
class PathParamDelegate<T : Any?>(
    ...
    private var defaultValueProvider: () -> T = { throw InputException("Missing $name path param") }
    ...
    private val value: T by lazy {
        val values = receiver.call.parameters.getAll(name)
